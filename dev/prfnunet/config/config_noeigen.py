...
class Config:
    def __init__(self) -> None:
        # ==> for output, CRITICAL
        self.version = "perm_rfn_unet_noeigen"
        ...
        self.save_path = "E:/Research/experiment_results/efficient_glob_perm_rfn_unet/{}/{}/{}/a={}, b={}, r={}".format(self.version, self.dataset, self.channels, self.theta_alpha, self.theta_beta, self.theta_gamma) # Perm. RFN. UNet w/o bilateral message-passing step
