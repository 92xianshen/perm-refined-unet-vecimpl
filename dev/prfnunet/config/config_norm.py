...
class Config:
    def __init__(self) -> None:
        ...
        self.save_path = "E:/Research/experiment_results/efficient_glob_perm_rfn_unet/perm_rfn_unet_norm/{}/{}/a={}, b={}, r={}".format(self.dataset, self.channels, self.theta_alpha, self.theta_beta, self.theta_gamma) # Perm. RFN. UNet w/o bilateral message-passing step
